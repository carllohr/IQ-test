...
function updateCountdown(){
	...
	time = time < 0 ? 0 : time;
	if (time == 0){
		runningQuestionIndex = 24;
		questions[runningQuestionIndex];
		renderQuestion();
		alert("Tiden är slut. Du fick " + score + " av 24");
...
function checkAnswer(answer){
	if (questions[runningQuestionIndex].correct == answer){
		score++;
		console.log("you have " + score + "out of" + " 24" + "correct so far");
	} else {
		console.log("you have " + score + "out of" + " 24" + "correct so far");
	}
...
if(runningQuestionIndex == 24){
	alert("Du fick " + score + "av" + 24 + "korrekta svar");
};
